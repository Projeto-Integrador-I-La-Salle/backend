...
Cria uma nova reserva recebendo a lista de itens e os dados do formulário de retirada.
...
```json
{
    ...
    "telefone_contato": "(51) 99999-9999",
    "data_retirada": "2025-12-25",
    "metodo_pagamento": "Pix",
    "observacao": "Retirar na parte da tarde"
}
```

#### Resposta de Sucesso (Status 201)
Retorna a reserva criada com os dados do formulário e os itens.
